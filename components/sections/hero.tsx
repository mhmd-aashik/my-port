   ...
   <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
    ...
    >
     ...
     <div className="relative rounded-full bg-background p-2">
      {/* Placeholder for avatar if needed, or just initials/logo */}
      <div className="h-24 w-24 md:h-32 md:w-32 rounded-full bg-muted flex items-center justify-center text-4xl font-bold">
       MA
      </div>
     </div>
    </motion.div>
    ...
    <div className="space-y-4">
     ...
     >
      I build scalable, production-ready web & mobile experiences with modern tech stacks.
     </motion.p>
    </div>
